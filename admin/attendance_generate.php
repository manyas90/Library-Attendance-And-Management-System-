<?php
    ...
    $pdf->SetTitle('MIT College Library Attendance: '.$from_title.' - '.$to_title);  
    ...
    $content = '';  
    $content .= '
      	<h2 align="center">MIT College Library Attendance Sheet</h2>
      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
      	<table border="1" cellspacing="0" cellpadding="3">  
           <tr>  
				  <th width="15%"><b>Date</b></th>
                  <th width="28%"><b>Full Name</b></th>
                  <th width="15%"><b>Enroment NO</b></th>
                  <th width="10%"><b>Roll NO</b></th>
                  <th width="8%"><b>ID NO</b></th>
